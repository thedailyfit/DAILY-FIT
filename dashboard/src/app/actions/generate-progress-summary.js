...
function generateProgressSummary(clientName, progressEntries) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const dataString = progressEntries.map(e => `- Date: ${e.date}, Weight: ${e.weight_kg}kg, Body Fat: ${e.body_fat_percentage || 'N/A'}%, Notes: ${e.notes || 'None'}`).join("\n");
            const prompt = `
