...
exports.default = DietEditorPage;
...
const diet_editor_wrapper_1 = require("@/components/dashboard/diet-editor-wrapper");
function getClientAndPlan(id) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { data: member } = yield supabase
            ...
            .eq('id', id)
            .single();
        const { data: mealPlan } = yield supabase
            .from('meal_plans')
            .select('*')
            .eq('member_id', id)
            .eq('status', 'active')
...
function DietEditorPage(_a) {
    return __awaiter(this, arguments, void 0, function* ({ params }) {
        ...
        return (<div className="h-[calc(100vh-4rem)] flex flex-col">
            ...
            {/* Main Content Area */}
            <diet_editor_wrapper_1.DietEditorWrapper initialData={mealPlan || { plan_data: { daily_calories: 2000, meals: [] } }} member={member}/>
        </div>);
    });
}
