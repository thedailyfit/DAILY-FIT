...
import { Dumbbell, UserPlus, Mail, ArrowRight, CheckCircle2 } from "lucide-react";
...
export default function GymSignupPage() {
    ...
    const handleSignup = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // 3. Log Referral if code was valid (Optional: done via Trigger or here explicitly)
            if (formData.referralCode) {
                // We can fetch the referrer_id from local DB if we wanted to verify immediately
                // ideally this logic lives in a Postgres Trigger or Edge Function to be secure
            }
